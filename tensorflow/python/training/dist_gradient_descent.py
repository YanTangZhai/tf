...
"""DistGradientDescent for TensorFlow."""
...
class DistGradientDescentOptimizer(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate, use_locking=False, name="DistGradientDescent"):
    ...
    """
    super(DistGradientDescentOptimizer, self).__init__(use_locking, name)
    self._learning_rate = learning_rate

  def _apply_dense(self, grad, var):
    return training_ops.apply_dist_gradient_descent(
        var,
